<template>
  ...
  <q-form style="width: 600px" class="q-pa-md q-mx-auto" >
    ...
    <q-input label="Main photo URL" v-model="project.photoUrl"></q-input>
    ...
    <div v-for="(photo, index) in project.photos" :key="index" class="row q-py-xs">
      ...
      <q-img :src="photo" :ratio="16/9" width="80px" class="q-ml-sm" loading="lazy" @load="console.log('loading')" @error="console.log('cannot load')" ></q-img>
    </div>
